# Sonar Treasure Hunt (Hundir la flota)
...
def showInstructions():
    print('''Instructions:
You are the captain of the Latin Jewel, a treasure-hunting ship. Your current mission
is to use sonar devices to find three sunken treasure chests at the bottom of
the ocean. But you only have sonar that finds distance, not direction.
